...
@PublishedApi
internal inline var <T> Promise<T>.state: ConcurrentState<T>?
    inline set(value) {
...
@PublishedApi
internal inline var <T> Promise<T>.resolveFn: ((T) -> Unit)?
    inline set(value) {
...
@PublishedApi
internal inline var <T> Promise<T>.rejectFn: ((Throwable) -> Unit)?
    inline set(value) {
