...
inline fun <E : Element> Element.find(by: By) = querySelector(by.selector).unsafeCast<E>()
inline fun <E : Element> Element.findAll(by: By) = querySelectorAll(by.selector).asList().unsafeCast<List<E>>()
inline fun <E : Element> Document.get(by: By) = querySelector(by.selector).unsafeCast<E>()
inline fun <E : Element> Document.getMany(by: By) = querySelectorAll(by.selector).unsafeCast<E>()